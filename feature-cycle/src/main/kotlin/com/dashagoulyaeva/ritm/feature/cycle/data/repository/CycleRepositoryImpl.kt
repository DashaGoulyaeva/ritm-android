...
class CycleRepositoryImpl
    ...
    constructor(
        ...
        override fun getActivePeriod(): Flow<CyclePeriod?> = cycleDao.getActivePeriod().map { it?.toDomain() }

        override suspend fun getActivePeriodOnce(): CyclePeriod? = cycleDao.getActivePeriodOnce()?.toDomain()
