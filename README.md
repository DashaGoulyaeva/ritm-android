# Ритм — product reset v2

> Статус ветки: полный реворк и переосмысление. MVP v1 сохранён тегом `mvp-v1-baseline` и больше не считается активной продуктовой рамкой.
>
> Новый контур работы: `docs/rework/README.md`.
...
- [docs/MVP_VERIFICATION_CHECKLIST.md](./docs/MVP_VERIFICATION_CHECKLIST.md) — чек-лист верификации MVP
- [docs/APK_BUILD_RUNBOOK.md](./docs/APK_BUILD_RUNBOOK.md) — регламент автоматической сборки APK
- [docs/PHASE2_EXPANSION_PLAN.md](./docs/PHASE2_EXPANSION_PLAN.md) — план второго этапа после MVP

## Проверка MVP и сборка APK

1. Чек-лист верификации: [docs/MVP_VERIFICATION_CHECKLIST.md](./docs/MVP_VERIFICATION_CHECKLIST.md)
2. Регламент автоматической сборки и отчёта: [docs/APK_BUILD_RUNBOOK.md](./docs/APK_BUILD_RUNBOOK.md)
3. План второго этапа: [docs/PHASE2_EXPANSION_PLAN.md](./docs/PHASE2_EXPANSION_PLAN.md)
