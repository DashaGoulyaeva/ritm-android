...
class HabitRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun getHabitById(habitId: Long): Habit? = habitDao.getHabitById(habitId)?.toDomain()

        override suspend fun createHabit(habit: Habit): Long = habitDao.insertHabit(habit.toEntity())
        ...
        override suspend fun isCheckedToday(
            habitId: Long,
            date: String,
        ): Boolean = habitDao.getCheckForHabitAndDate(habitId, date) != null
        ...
        private fun HabitCheckEntity.toDomain() =
            HabitCheck(
                id = id,
                habitId = habitId,
                date = date,
