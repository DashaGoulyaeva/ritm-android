...
> Статус: текущий файл содержит историю MVP v1 и backlog до реворка. Для новой продуктовой рамки использовать `docs/rework/README.md` и документы v2. Старые задачи не переносятся автоматически.
