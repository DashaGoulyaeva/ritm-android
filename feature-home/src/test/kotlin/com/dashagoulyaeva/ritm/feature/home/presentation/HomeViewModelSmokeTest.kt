...
class HomeViewModelSmokeTest {
    ...
    private class FakeFastingRepository : FastingRepository {
        ...
        override suspend fun startSession(plan: FastingPlan, customHours: Int): Long = 0L
    ...
    @Test
    fun `initial isLoading is true before aggregator emits`() = runTest {
    ...
    @Test
    fun `showWaterSheet toggles correctly`() = runTest {
    ...
    @Test
    fun `hideWaterSheet resets flag`() = runTest {
        viewModel.showWaterSheet()
    ...
    @Test
    fun `showFastingSheet toggles correctly`() = runTest {
